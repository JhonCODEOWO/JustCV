                    ...
                    <div>
                        {(!editing)
                            ? 
                                headerContent
                            : 
                                (!headerContent)? 'Nuevo elemento': headerContent
                        }
                    </div>
                    {editing && <button type="button" className="rounded-full bg-base-100 cursor-pointer" onClick={onAccept}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="m7 14l5-5l5 5z"/></svg>
                    </button> }
                    {!editing && 
                        <button className="rounded-full bg-base-100 cursor-pointer" type="button" onClick={onEdit}>
