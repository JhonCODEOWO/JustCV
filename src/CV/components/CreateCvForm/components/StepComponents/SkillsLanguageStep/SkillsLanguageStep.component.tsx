...
function SkillsLanguageStep({
  ...
  return (
    <>
      ...
      />
      <section className="flex flex-col md:grid md:grid-cols-2 gap-x-4 mt-4">
        <div>
          <HeaderWithContentComponent
            level={4}
            title="Habilidades"
          ...
          <div className="flex flex-col gap-y-3 my-5">
            {skills.map((skill, index) => (
              <div key={skill.id} className="relative rounded bg-base-200 px-3">
        ...
        <div>
          ...
          <section className="flex flex-col gap-y-3 my-5">
            {languages.map((language, index) => (
              <div key={language.id} className="relative rounded bg-base-200 px-3">
                <InputComponent<CreateCvFormBody>
                  errors={errors}
